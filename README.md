...
* 上傳到論文庫審核的電子版不需要授權書，排版順序可以參考 [這個網頁的第一點：論文次序](https://registra.site.nthu.edu.tw/var/file/211/1211/img/153498830.pdf)
  * 詳細資訊可參考 系網頁->學生資源->畢業相關規定->碩士班畢業程序 或是 [圖書館>提交學位論文之步驟](https://www.lib.nthu.edu.tw/use/thesis_submission.html)
* 至 圖書館網頁->圖書館服務->畢業離校與論文->學位論文提交入口 確認學位資料、上傳論文電子檔、填寫授權開放時間等相關資訊，老師的名字在系統裡要和論文裡一致，例如論文裡是打Jerry Chou，系統裡要打Chou, Jerry（因為系統一定要 姓, 名）
  * 中、英文姓名、學院名稱資料如需修改請洽註冊組。需增補英文姓名者，請攜帶護照至註冊組辦理。
  * 論文基本資料、指導教授、口試委員資料如需變更請洽系辦。完成修改後，重新登入博碩士論文庫，系統將自動擷取更新後的資料。
* 電子版檔案依照 [說明](http://www.lib.nthu.edu.tw/ETD/downloads/upload.pdf) 修改後上傳，系統會幫你設定好浮水印和 PDF 保護，檢核沒問題後，就送出給指導教授和圖書館審核
* 請指導教授進系統審核、圖書館審核需要兩個工作天，不接受急件
* 審核通過後即可取得授權書檔案

### 紙本

* 最好先等圖書館審核過電子版再去印，因為如果你先印然後圖書館說哪裡要改就白印了
  * 如果要申請論文延後公開，拜託請在清大博碩士論文庫裡面下載列印！！不要在網路上搜尋或是跟學長姐／同學拿檔案了！！絕對會被退，請在清華大學博碩士論文庫裡面列印屬於你自己的延後公開申請書，再到系辦蓋系所主管章。
  * 清大紙本授權書、電子檔授權書和國家圖書館的授權書已經整合成一份了！！（等圖書館審核通過之後，系統會自行產生只屬於你的授權書，請在清華大學博碩士論文庫裡面列印），沒有國家圖書館學位論文延後公開申請書這個東西，校務資訊系統的是舊版也不能使用
